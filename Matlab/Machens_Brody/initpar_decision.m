...
par.Nneurons = 500;    %Number of neurons/node in spiking simulation
par.mfnoise  =   sqrt(0.25);    %Variance of additive noise in mean-field simulation
par.noiseTimeStep = 25; % (ms) Add the additive noise directly to x and y every this many timesteps
...
par.init_Sigma = [0.01, 0.01]; %Variance of initial state in mean-field simulation
...
par.TSF1    = 0;  % offset of f1 (msec)
par.TSO2    = 0;  % onset of f2 (msec)
